...
if("TRUE" STREQUAL "TRUE")
  set(data_generator_SOURCE_PREFIX /Mars-Rover/src/VINS-Mono/data_generator)
  set(data_generator_DEVEL_PREFIX /Mars-Rover/devel)
  ...
  set(data_generator_INSTALL_PREFIX /Mars-Rover/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'data_generator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'data_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Mars-Rover/src/VINS-Mono/data_generator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT data_generator_NUM_DUMMY_TARGETS)
      set(data_generator_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::data_generator::wrapped-linker-option${data_generator_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR data_generator_NUM_DUMMY_TARGETS "${data_generator_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::data_generator::wrapped-linker-option${data_generator_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND data_generator_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND data_generator_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${data_generator_dep}_FOUND)
      find_package(${data_generator_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${data_generator_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(data_generator_EXPORTED_TARGETS ${${data_generator_dep}_EXPORTED_TARGETS})
endforeach()
